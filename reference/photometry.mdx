---
title: "photometry module: run_pipeline() API Reference"
sidebarTitle: "photometry"
description: "API reference for photometry.run_pipeline(): inputs, pipeline steps, output dict fields, quality flag logic, and internal helper functions."
---
