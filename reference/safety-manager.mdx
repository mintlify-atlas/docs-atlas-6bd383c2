...
<ParamField path="safety.disconnect_timeout" type="float" default="60">
  Number of seconds without a heartbeat before the manager considers the connection lost and begins reconnection attempts.
</ParamField>

<ParamField path="safety.heartbeat_interval" type="float" default="10">
...
<ParamField path="safety.reconnect_delay" type="float" default="15">
