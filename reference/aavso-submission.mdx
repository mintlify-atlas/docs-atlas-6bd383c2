---
title: "aavso_submission: submit() to AAVSO WebObs Reference"
sidebarTitle: "AAVSO Submission"
description: "API reference for aavso_submission.submit(): Extended File Format, WebObs POST fields, 7 result keys, status values, audit trail files, and config keys."
---
