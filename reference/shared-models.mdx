...
sidebarTitle: "shared_models"
description: "API reference for the shared_models dataclasses: NodeInfo, TargetInfo, PlanItem, ObservationPlan, and Measurement, with to_dict() and from_dict() round-tripping."
---
