---
title: "fits_export: export_enhanced_fits() Full API Reference"
sidebarTitle: "FITS Export"
description: "Copies a FITS file into a dated directory and adds observatory, detector, and photometry keywords to its header. export_enhanced_fits() API reference."
---
