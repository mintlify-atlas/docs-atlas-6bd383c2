...
description: "Node v1 controls a Seestar S50 via ALPACA, watches for new FITS files, runs differential photometry, and submits calibrated magnitudes to AAVSO."
---
